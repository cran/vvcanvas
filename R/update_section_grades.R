...
#'
#' @description This function updates the assignment grades of a specific assignment in a
#' specific section in the Canvas LMS API.
#'
#' @details It updates the grading on multiple students' assignment submissions in an
#' asynchronous job. The user must have permission to manage grades in the section.
...
#' @param section_id The ID of the section for which to generate the gradebook.
